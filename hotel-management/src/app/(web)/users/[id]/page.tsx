...
const UserDetails = (props: {params: {id: string}}) => {
  ...
  const [currentNav, setCurrentNav] = useState<"bookings" | "amount" | "ranting">("bookings");
...
const {
  ...
  return (<div className="mx-auto px-2 md:px-4 py10">
    <div className="grid md:grid-cols-12 gap-10">
      ...
      <div className="md:col-span-8 lg:col-span-9">
        ...
        <ol
            ...
            >
              <li onClick={() => setCurrentNav("bookings")} className='inline-flex items-center cursor-pointer'>
            ...
            >
              <li onClick={() => setCurrentNav("amount")} className='inline-flex items-center cursor-pointer'>
                <GiMoneyStack/>
                <a className='inline-flex items-center mx-1 md:mx-3 text-xs md:text-sm font-medium'>
                  Amount Spent
                </a>
